...
// Setup page.
$PAGE->set_url('/report/feedbackviewer/index.php', array('id' => $id));
$PAGE->set_pagelayout('report');
$returnurl = new moodle_url('/course/view.php', array('id' => $id));

// Check permissions.
$coursecontext = context_course::instance($course->id);
require_capability('report/feedbackviewer:view', $coursecontext);

// Get users.
$users = report_feedbackviewer_get_all_users($coursecontext);
...
if (!empty($uid)) {
    report_feedbackviewer_build_report($course, $uid);
}
